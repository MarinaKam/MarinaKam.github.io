...
(function() {
  ...
  // Don't css single trailing space
  MT("trailingSpace1",
     "foo ");
  ...
  // Reference-css links with implicit link name
  MT("linkImplicit",
  ...
  // Link label, for reference-css links (taken from documentation)
